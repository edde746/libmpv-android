...
# Prebuilt static library (downloaded by download-deps.sh); the header is
# vendored in the repo because the release tarballs ship only the archive.
...
[ "$ndk_triple" == "arm-linux-androideabi" ] && rust_triple=armv7-linux-androideabi
